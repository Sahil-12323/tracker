...
const styles = StyleSheet.create({
  ...
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,.62)', justifyContent: 'flex-end' }, sheet: { backgroundColor: 'rgba(17,17,17,.97)', borderColor: '#27272A', borderWidth: 1, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, minHeight: '54%' }, handle: { width: 48, height: 5, borderRadius: 99, backgroundColor: '#3F3F46', alignSelf: 'center', marginBottom: 16 }, hero: { width: '100%', height: 130, borderRadius: 22, marginBottom: 18 }, sheetTitle: { color: '#FFFFFF', fontSize: 26, fontWeight: '900' }, row: { flexDirection: 'row', justifyContent: 'space-between', gap: 12, borderBottomWidth: 1, borderBottomColor: '#27272A', paddingVertical: 12 }, rowLabel: { color: '#A1A1AA', fontWeight: '800' }, rowValue: { color: '#FFFFFF', fontWeight: '900', flex: 1, textAlign: 'right' }, config: { color: '#A1A1AA', marginTop: 12, fontWeight: '700' }, actions: { flexDirection: 'row', gap: 10, paddingTop: 18 }, secondary: { flex: 1, minHeight: 52, borderRadius: 14, borderWidth: 1, borderColor: '#27272A', backgroundColor: 'rgba(255,255,255,.04)', alignItems: 'center', justifyContent: 'center' }, secondaryText: { color: '#FFFFFF', fontWeight: '900' }, confirm: { flex: 1, minHeight: 52, borderRadius: 14, backgroundColor: '#007AFF', alignItems: 'center', justifyContent: 'center', shadowColor: '#007AFF', shadowOpacity: .5, shadowRadius: 14 }, confirmText: { color: '#FFFFFF', fontWeight: '900' },
});