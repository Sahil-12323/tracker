    ...
    <ScrollView style={styles.wrap} contentContainerStyle={styles.content}>
      ...
      <Modal visible={!!detection} transparent animationType="slide" onRequestClose={() => setDetection(null)}>
        <View style={styles.overlay}><View style={styles.sheet}><View style={styles.handle} /><Image source={{ uri: IMAGES.detection }} style={styles.hero} /><Text style={styles.sheetTitle}>Detected application</Text>
          {detection && <View style={styles.modalBody}><Row label="Company" value={detection.company_name} /><Row label="Role" value={detection.role} /><Row label="Status" value={detection.status} /><Row label="Date" value={detection.applied_date} /><Text style={styles.config}>{detection.config_message}</Text></View>}
...
const styles = StyleSheet.create({
  wrap: { flex: 1 }, content: { padding: 20, paddingBottom: 120 }, kicker: { color: '#F5A623', fontSize: 13, fontWeight: '900', letterSpacing: 1.8 }, title: { color: '#FFFFFF', fontSize: 30, lineHeight: 36, fontWeight: '900', marginTop: 8, marginBottom: 20 },
  sourceRow: { flexDirection: 'row', gap: 8, marginBottom: 12 }, source: { flex: 1, borderWidth: 1, borderColor: '#27272A', backgroundColor: 'rgba(255,255,255,.04)', borderRadius: 14, minHeight: 46, alignItems: 'center', justifyContent: 'center' }, sourceActive: { backgroundColor: '#007AFF', borderColor: '#3395FF', shadowColor: '#007AFF', shadowOpacity: .35, shadowRadius: 14 }, sourceText: { color: '#A1A1AA', fontWeight: '900' }, sourceTextActive: { color: '#FFFFFF' },
  attach: { flexDirection: 'row', gap: 10, alignItems: 'center', borderRadius: 16, borderWidth: 1, borderColor: '#27272A', backgroundColor: '#111111', padding: 16, marginBottom: 12 }, attachText: { color: '#3395FF', fontWeight: '900' }, textarea: { minHeight: 190, textAlignVertical: 'top', borderRadius: 18, borderWidth: 1, borderColor: '#27272A', backgroundColor: '#111111', color: '#FFFFFF', padding: 16, fontSize: 16 }, message: { color: '#A1A1AA', fontWeight: '700', marginTop: 12 }, primary: { minHeight: 56, borderRadius: 16, backgroundColor: '#007AFF', alignItems: 'center', justifyContent: 'center', marginTop: 16, shadowColor: '#007AFF', shadowOpacity: .5, shadowRadius: 18 }, primaryText: { color: '#FFFFFF', fontSize: 16, fontWeight: '900' },
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,.62)', justifyContent: 'flex-end' }, sheet: { backgroundColor: 'rgba(17,17,17,.97)', borderColor: '#27272A', borderWidth: 1, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 18, maxHeight: '86%' }, handle: { width: 48, height: 5, borderRadius: 99, backgroundColor: '#3F3F46', alignSelf: 'center', marginBottom: 12 }, hero: { width: '100%', height: 92, borderRadius: 20, marginBottom: 12 }, sheetTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '900' }, modalBody: { marginTop: 2 }, row: { flexDirection: 'row', justifyContent: 'space-between', gap: 12, borderBottomWidth: 1, borderBottomColor: '#27272A', paddingVertical: 8 }, rowLabel: { color: '#A1A1AA', fontWeight: '800' }, rowValue: { color: '#FFFFFF', fontWeight: '900', flex: 1, textAlign: 'right' }, config: { color: '#A1A1AA', marginTop: 10, fontWeight: '700', lineHeight: 18 }, actions: { flexDirection: 'row', gap: 10, paddingTop: 12 }, secondary: { flex: 1, minHeight: 50, borderRadius: 14, borderWidth: 1, borderColor: '#27272A', backgroundColor: 'rgba(255,255,255,.04)', alignItems: 'center', justifyContent: 'center' }, secondaryText: { color: '#FFFFFF', fontWeight: '900' }, confirm: { flex: 1, minHeight: 50, borderRadius: 14, backgroundColor: '#007AFF', alignItems: 'center', justifyContent: 'center', shadowColor: '#007AFF', shadowOpacity: .5, shadowRadius: 14 }, confirmText: { color: '#FFFFFF', fontWeight: '900' },
});